            ...
            rdp: {
                ajax: function(e) {
                    ...
                    e.success = function(e) {
                        e && "error" == e.flag ? layer.alert(e.msg, {
...
var Hot = function() {
    var l, t = function() {
            Handsontable.hooks.add("afterListen", e, l),
                Handsontable.hooks.add("afterDeselect", a, l),
                Handsontable.hooks.add("afterUnlisten", o, l),
                Handsontable.hooks.add("afterSelection", n, l),
                Handsontable.hooks.add("afterSelectionByProp", r, l),
                Handsontable.hooks.add("afterSelectionEnd", i, l),
                Handsontable.hooks.add("afterSelectionEndByProp", s, l),
                Handsontable.hooks.add("afterCreateRow", d, l),
                Handsontable.hooks.add("afterCreateCol", c, l),
                Handsontable.hooks.add("afterRemoveRow", u, l),
                Handsontable.hooks.add("afterRemoveCol", p, l),
                Handsontable.hooks.add("beforeOnCellMouseOver", f, l),
                Handsontable.hooks.add("afterOnCellMouseOver", g, l),
                Handsontable.hooks.add("beforeOnCellMouseOut", m, l),
                Handsontable.hooks.add("afterOnCellMouseOut", h, l),
                Handsontable.hooks.add("beforeOnCellMouseDown", v, l),
                Handsontable.hooks.add("afterOnCellMouseDown", b, l),
                Handsontable.hooks.add("afterBeginEditing", y, l),
                Handsontable.hooks.add("afterSetDataAtCell", C, l),
                Handsontable.hooks.add("beforeChange", S, l),
                Handsontable.hooks.add("beforeChangeRender", w, l),
                Handsontable.hooks.add("afterChange", M, l),
                Handsontable.hooks.add("beforeContextMenuShow", D, l),
                Handsontable.hooks.add("afterContextMenuShow", T, l),
                Handsontable.hooks.add("afterContextMenuHide", x, l),
                Handsontable.hooks.add("beforeUndo", k, l),
                Handsontable.hooks.add("beforeRedo", k, l),
                Handsontable.hooks.add("afterSetDataAtRowProp", A, l),
                Handsontable.hooks.add("afterRedo", P, l),
                Handsontable.hooks.add("afterUndo", R, l),
                Handsontable.hooks.add("afterSetCellMeta", _, l),
                Handsontable.hooks.add("beforeCopy", I, l),
                Handsontable.hooks.add("afterCopy", H, l),
                Handsontable.hooks.add("beforeCut", F, l),
                Handsontable.hooks.add("afterCut", B, l),
                Handsontable.hooks.add("beforePaste", z, l),
                Handsontable.hooks.add("afterPaste", O, l),
                Handsontable.hooks.add("beforeMergeCells", E, l),
                Handsontable.hooks.add("afterMergeCells", L, l),
                Handsontable.hooks.add("beforeUnmergeCells", j, l),
                Handsontable.hooks.add("afterUnmergeCells", U, l),
                Handsontable.hooks.add("beforeRenderer", V, l),
                Handsontable.hooks.add("afterRenderer", W, l),
                Handsontable.hooks.add("beforeKeyDown", Z, l),
                Handsontable.hooks.add("afterDocumentKeyDown", Y, l),
                Handsontable.hooks.add("beforeUndo", k, l),
                Handsontable.hooks.add("beforeRedo", N, l),
                Handsontable.hooks.add("afterUndo", R, l),
                Handsontable.hooks.add("afterRedo", P, l),
                Handsontable.hooks.add("afterColumnResize", q, l),
                Handsontable.hooks.add("afterRowResize", Q, l)
        },
    ...
    $.each(e,
        function(e, t) {
            if (null != t.value) {
                ...
                a[0].style.backgroundImage = 'url("' + t.value + '")',
                    a[0].style.backgroundRepeat = "no-repeat",
                    a.css({
                        position: "absolute",
                        left: t.left + "px",
                        top: t.top + "px",
                    ...
                    a.data("r", o),
                    a.data("c", n),
                    a[0].style.backgroundSize = t.width + "px " + t.height + "px",
                    $(".ht_master .wtHider").append(a),
                    a.myDrag({
                        randomPosition: !1,
                        direction: "all",
                        handler: !1,
                    ...
                    a.dragDivResize($(".ht_master .wtHider")[0],
                        function(e, t, a) {
                            var o = hot.Methods.getCellMeta(e.data("r"), e.data("c")).image[e.data("index")];
                            o.width = t,
                                o.height = a
                    ...
                    a.bind("click",
                        function() {
                            return $(".cell-img").removeClass("curr-img"),
...
function openDic() {
    ...
    if (l) {
        var e = l[0],
            t = hot.Methods.getCellMeta(e[0], e[1]).dic,
            o = "",
            n = "";
        t && (o = t.split("=")[0], n = t.split("=")[1]),
            layer.open({
                type: 1,
                area: ["554px", "166px"],
                title: "字典项配置",
                ...
                success: function(a, e) {
                    a.find("#dicds").empty(),
                        a.find("#dicTypeVal").val(n);
                    var t = getDataSetsNodesByParam("dic", !0);
                    a.find("#dicds").append('<option value=""></option>'),
                        $.each(t,
                            function(e, t) {
                ...
                btn: ["保存", "取消"],
                yes: function(e, t) {
                    var a = t.find("#dicds").val(),
                        o = t.find("#dicTypeVal").val(),
                        n = l[0];
                    if (a && o) $("#parmdic").val(a + "=" + o),
                        hot.Methods.setCellMeta(n[0], n[1], "dic", a + "=" + o);
                    else {
                        $("#parmdic").val("");
...
$(function() {
    var a, o = window.URL || window.webkitURL,
        n = $("#image"),
        t = $("#dataX"),
        r = $("#dataY"),
        l = $(".rdp-cropper"),
        ...
        p = $("#dataScaleX"),
        f = $("#dataScaleY"),
        e = $("#save-cropper-image"),
        g = $("#cancel-cropper-image"),
        m = !1,
        h = {
            aspectRatio: 16 / 9,
            preview: ".rdp-img-preview",
            crop: function(e) {
    ...
    n.on({
        ...
        $(".rdp-img-menu .menu-item").bind("click",
            function() {
                var e = $(this).data();
                if (n.data("cropper") && e.method) switch (e = $.extend({},
                    e), result = n.cropper(e.method, e.option, e.secondOption), e.method) {
                    case "scaleX":
                    case "scaleY":
        ...
        $(".docs-toggles").on("change", "input",
            function() {
                var e = $(this),
                    t = e.attr("name");
                "radio" === e.prop("type") && (h[t] = e.val(), e.parents("li").addClass("active").siblings().removeClass("active")),
                    n.cropper("destroy").cropper(h)
            }),
        $(".docs-data .cropper-data").bind("input propertychange",
            function() {
                m = !0;
                var e = {};
                e.x = Number(t.val()),
                    e.y = Number(r.val()),
                    e.height = Number(i.val()),
                    e.width = Number(s.val()),
                    e.rotate = Number(u.val()),
                    e.scaleX = Number(p.val()),
                    e.scaleY = Number(f.val()),
                    m = !1,
                    n.cropper("setData", e),
                    e = null
            }),
        $(".docs-data .cropper-ratio").bind("input propertychange",
            function() {
        ...
        e.bind("click",
            function() {
                ...
                if (e.width = d.val(), e.height = c.val(), e.fillColor = "#fff", result = n.cropper("getCroppedCanvas", e), "importImage" == imageActionName) {
                    ...
                    if (t) {
                        var a = t[0],
                            o = hot.Methods.getCell(a[0], a[1]);
                        hot.Methods.setCellMeta(a[0], a[1], "bgimage", result.toDataURL()),
                            o.style.backgroundImage = 'url("' + result.toDataURL() + '")',
                            o.style.backgroundRepeat = "no-repeat"
                    }
                } else if ("addImage" == imageActionName) {
                    var i = $('<div class="cell-img"></div>');
                    i[0].style.backgroundImage = 'url("' + result.toDataURL() + '")',
                        i[0].style.backgroundRepeat = "no-repeat",
                        i.css({
                            position: "absolute",
                            left: "49px",
                            top: "25px",
                    ...
                    s.onload = function() {
                        ...
                        i.css({
                            ...
                            i[0].style.backgroundSize = e + "px " + t + "px",
                            $(".ht_master .wtHider").append(i),
                            i.myDrag({
                                randomPosition: !1,
                                direction: "all",
                                handler: !1,
                            ...
                            i.dragDivResize($(".ht_master .wtHider")[0],
                                function(e, t, a) {
                                    var o = hot.Methods.getCellMeta(e.data("r"), e.data("c")).image[e.data("index")];
                                    o.width = t,
                                        o.height = a
                        ...
                        if (a) {
                            var o = a[0],
                                n = hot.Methods.getCellMeta(o[0], o[1]).image || [],
                                r = {};
                            r.value = result.toDataURL(),
                                r.width = e,
                                r.height = t,
                                r.top = 0,
                                r.left = 0,
                            ...
                            i.data("r", o[0]),
                                i.data("c", o[1]),
                                i.data("index", l),
                                hot.Methods.setCellMeta(o[0], o[1], "image", n)
                        }
                        i.bind("click",
                            function() {
                                return $(".cell-img").removeClass("curr-img"),
    ...
    o ? v.bind("change",
        ...
        }) : v.prop("disabled", !0).parent().addClass("disabled"),
        $(document).bind("click",
            function() {
...
var dsname = "",
    ...
    dataExprZNodes = [{
        ...
        },
        {
            ...
            pId: 40,
            name: "rmb()",
            title: "参数：rmb(Number num)、rmb(String num)\n说明：转人民币大写\n返回值：人民币大写字符串"
        },
        {
            id: 4013,
            pId: 40,
...
function filld(e) {
    "" != dsname && (e = e.replace("$F{", "$F{" + dsname + ".")),
        insertAtCursor(document.getElementById("exptext"), e);
...
function initExpr() {
    ...
    $("#aexpr").empty(),
        ...
        $.each(e,
            function(e, t) {
                $("#aexpr").append('<option value="' + t.name + '">' + t.name + "</option>"),
                    $("#ds").append('<option value="' + t.name + '">' + t.name + "</option>")
            }),
        $("#aexpr").append('<option value="parm">参数</option>')
}
function changeDataSets(e) {
    if ($("#dsvs").empty(), $("#dsvs").append("<option value=''></option>"), "" == e) $("#dsvt").show().val("").focus(),
        $("#dsvs").hide();
    else {
...
function setdv(e) {
    ...
    if (t) {
        var a = "";
        "" != e.value && (a = "=" + $("#ds").val() + "." + e.value),
            hot.Methods.setDataAtCell(t[0][0], t[0][1], a)
    }
}
function setv(e, t) {
    var a = hot.Methods.getSelected();
...
function setCursorPosition(t, a) {
    ...
    if (o < a) return ! 1;
    setTimeout(function() {
            if (t.focus(), t.setSelectionRange) t.setSelectionRange(a, a);
            else {
                var e = t.createTextRange();
                e.moveStart("character", -o),
...
function submit() {
    try {
        ...
        if (e) {
            ...
            hot.Methods.setCellMeta(t[0], t[1], "warnings", o),
                setCellval(a)
        }
    } catch(e) {}
}
...
function dataExprTabs(e) {
    var t = $(e),
        a = t.parent().index();
    t.parents("ul").find(".current").removeClass("current"),
        t.parent().addClass("current"),
        t.parents(".dataExpr").find(".tabs-content .tabs-pages").addClass("tabs-hiden"),
        t.parents(".dataExpr").find(".tabs-content .tabs-pages.tabs" + a).removeClass("tabs-hiden")
}
...
var prefix = "warning",
    warningTree = {
        ...
        setting: {
            ...
            callback: {
                onClick: function(e, t, a) {
                    if (a.isParent) setWarningStyleData(a.nodeData.style, a.name);
                    else {
                        var o = a.getParentNode();
                        setWarningStyleData(o.nodeData.style, o.name),
                            setWarningSymbolData(a.nodeData.symbol)
                    }
                }
            }
        },
            ...
            $.each(t,
                function(n, e) {
                    ...
                    t.id = prefix + n,
                        ...
                        t.isParent = !0;
                    var a = e.style;
                    $.extend(!0, warningTree.defaultStyle, a),
                        t.nodeData = {
                            style: a
                        },
                        r.push(t),
                        $.each(e.symbols,
                            function(e, t) {
                                var a = {},
                                    o = t;
                                $.extend(!0, warningTree.defaultSymbol, o),
                                    a.id = prefix + n + e,
                                    a.name = warningTree.getSymbolName(o),
                                    a.pId = prefix + n,
                                    a.isParent = !1,
                                    a.nodeData = {
                                        symbol: o
        ...
        update: function(e) {
            var t = $.fn.zTree.getZTreeObj(e),
                a = t.getSelectedNodes(),
                o = a[0];
            if (0 < a.length) if (o.isParent) o.name = warningTree.getConditionName(),
                o.nodeData = {
                    style: getWarningStyleData()
                },
                t.updateNode(o);
                ...
                n.name = warningTree.getConditionName(),
                    n.nodeData = {
                        style: getWarningStyleData()
                    },
                    t.updateNode(n),
                    ...
                    o.name = warningTree.getSymbolName(getWarningSymbolData()),
                    t.updateNode(o)
        ...
        getSymbolName: function(e) {
            var t = "";
            return void 0 !== e && (t += e.andOr, t += e.operatorText, t += e.value, "" != e.explain && (t += "(" + e.explain + ")")),
                t
        },
...
function getWarningStyleData() {
    var e = $(".table-warning").find(".tr-attr"),
        t = e.find("input[name='tdFontSize']").val(),
        a = e.find("input[name='tdFontWeight']").val(),
        o = e.find("input[name='tdFontColor']").val(),
        n = e.find("input[name='tdFontBgColor']").val(),
        r = {};
    return r.font_size = t,
        r.font_weight = a,
        r.color = o,
        r.background_color = n,
        r
}
function getWarningSymbolData() {
    var e = $(".table-warning").find(".tr-symbol"),
        t = e.find("select[name='operator']").val(),
        a = e.find("select[name='operator']").find("option:selected").text(),
        o = e.find("input[name='tdValue']").val(),
        n = e.find("input[name='andOr']:checked").val(),
        r = e.find("textarea[name='explain']").val(),
        l = {};
    return l.operator = t,
        l.operatorText = a,
        l.andOr = n,
...
function setWarningStyleData(e, t) {
    ...
    $(".table-warning").find(".tr-condition_name").find("input[name='conditionName']").val(t),
        $.extend(!0, warningTree.defaultStyle, e),
        a.find("input[name='tdFontSize']").val(e.font_size),
        a.find("input[name='tdFontWeight']").val(e.font_weight),
        a.find("input[name='tdFontColor']").val(e.color),
        a.find("input[name='tdFontBgColor']").val(e.background_color),
        e.background_color ? ($("#tdchangeBgColor").css("background-color", e.background_color), $("#tdchangeBgColor").css("background-image", "")) : ($("#tdchangeBgColor").css("background-color", ""), $("#tdchangeBgColor").css("background-image", "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAIAAADZF8uwAAAAGUlEQVQYV2M4gwH+YwCGIasIUwhT25BVBADtzYNYrHvv4gAAAABJRU5ErkJggg==)")),
        e.color ? ($("#tdchangeColor").css("background-color", e.color), $("#tdchangeColor").css("background-image", "")) : ($("#tdchangeColor").css("background-color", ""), $("#tdchangeColor").css("background-image", "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAIAAADZF8uwAAAAGUlEQVQYV2M4gwH+YwCGIasIUwhT25BVBADtzYNYrHvv4gAAAABJRU5ErkJggg==)"));
    var o = $(".table-warning").find(".tr-symbol");
    o.find("select[name='operator']").val("0"),
        o.find("input[name='tdValue']").val(""),
        o.find("input[name='andOr'][value='and']").prop("checked", !0),
        o.find("textarea[name='explain']").val("")
}
function setWarningSymbolData(e) {
    var t = $(".table-warning").find(".tr-symbol");
    $.extend(!0, warningTree.defaultSymbol, e),
        t.find("select[name='operator']").val(e.operator),
        t.find("input[name='tdValue']").val(e.value),
        t.find("input[name='andOr'][value='" + e.andOr + "']").prop("checked", !0),
        t.find("textarea[name='explain']").val(e.explain)
}
function setDataExprWarningDataDefault() {
    var e = $(".table-warning").find(".tr-attr"),
        t = $(".table-warning").find(".tr-symbol");
    $(".table-warning").find(".tr-condition_name").find("input[name='conditionName']").val(""),
        e.find("input[name='tdFontSize']").val(""),
        e.find("input[name='tdFontWeight']").val(""),
        e.find("input[name='tdFontColor']").val(""),
        e.find("input[name='tdFontBgColor']").val(""),
        $("#tdchangeBgColor").css("background-image", "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAIAAADZF8uwAAAAGUlEQVQYV2M4gwH+YwCGIasIUwhT25BVBADtzYNYrHvv4gAAAABJRU5ErkJggg==)"),
        $("#tdchangeColor").css("background-image", "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAIAAADZF8uwAAAAGUlEQVQYV2M4gwH+YwCGIasIUwhT25BVBADtzYNYrHvv4gAAAABJRU5ErkJggg==)"),
        t.find("select[name='operator']").val("0"),
        t.find("input[name='tdValue']").val(""),
        t.find("input[name='andOr'][value='and']").prop("checked", !0),
        t.find("textarea[name='explain']").val("")
}
var dataLinkLayero, parmstr = "",
    filestr = "",
    datalinkparmData = {};
function addLink() {
    var e = hot.Methods.getSelected();
    if (e) {
        var t = e[0],
            c = hot.Methods.getCellMeta(t[0], t[1]),
            a = hot.Methods.getDataAtCell(t[0], t[1]);
        if (!a) return layer.msg("当前单元格未配置字段"),
            !1;
        ...
        layer.open({
            ...
            success: function(o, e) {
                datalinkparmData = {},
                    (dataLinkLayero = o).find("#temlist").empty(),
                    o.find("#plist").empty(),
                    o.find("#myconfig").val(""),
                    o.find("#temlist").append("<option value='' >请选择</option>");
                var n = "";
                filestr = "";
                var t = c.link;
                if (t) {
                ...
                "" != n && $.rdp.ajax({
                    ...
                    async: !1,
                    success: function(e) {
                        for (var t in parmstr = "",
                            e) parmstr += "<option value=" + t + ">" + t + "</option>"
                    }
                });
                var i = $.fn.zTree.getZTreeObj("dataSets"),
                    s = i.getNodeByParam("dataSetName", u[0], null),
                    d = i.getNodeByParam("type", "field", s).children;
                $.each(d,
                    function(e, t) {
                        filestr += "<option value=" + u[0] + "." + t.columnName + ">" + u[0] + "." + t.columnComments + "</option>"
                    }),
                    $.each(datalinkparmData,
                        function(e, t) {
                    ...
                    $.rdp.ajax({
                        ...
                        success: function(e) {
                            for (var t in e) {
                                var a = "";
                                n == e[t].uuid && (a = " selected = 'selected'"),
                                    o.find("#temlist").append("<option value='" + e[t].uuid + ",reporttype:" + getreportstyle(e[t].reportStyle) + "' " + a + ">" + e[t].name + "</option>")
                            }
                            $("#padd").show()
                        }
                    }),
                    o.find("#temlist").bind("change",
                        function() {
...
function createlink() {
    ...
    dataLinkLayero.find("#plist").find(".top").each(function() {
        var e = $(this).find(".filelist")[0].value,
            t = $(this).find(".parmlist")[0].value;
        a += t + ":(#=" + e + "#),"
    }),
...
function addp(e, t) {
    ...
    dataLinkLayero.find("#plist").append(o),
        dataLinkLayero.find("#filelist" + a).val(e),
        dataLinkLayero.find("#parmlist" + a).val(t)
}
function removeLink() {
    var e = hot.Methods.getSelected();
    if (e) {
...
var tempLayeroForParms, tempDataReportLayerIndex, tempTreeNodeForSets, settingForParms = {
        ...
        callback: {
            beforeDrag: beforeDragForParms,
            onClick: zTreeOnClickForParms,
            beforeRemove: zTreeBeforeRemoveForParms
        }
    },
    zNodesForParms = [{
        id: 0,
...
function zTreeBeforeRemoveForParms(e, t) {
    return layer.confirm("确认删除参数  “" + t.name + "” 吗？", {
            btn: ["确定", "取消"]
        },
        function(e) {
            $.fn.zTree.getZTreeObj("dataParms").removeNode(t),
                layer.alert("删除成功!")
        },
        function(e) {
            layer.close(e)
...
function addDataParms(a) {
    layer.open({
        ...
        btn: ["添加", "取消"],
        yes: function(e, t) {
            a ? editParmNode(t, a) : addParmNode(t),
                layer.close(e)
        },
        btn2: function(e, t) {
            layer.close(e)
...
function addParmNode(e) {
    var t = getDomAllVals(e[0]),
        a = $.fn.zTree.getZTreeObj("dataParms"),
        o = a.getNodes(),
        n = $.extend(!0, {},
            t);
    n.name = t.parmCName,
...
function editParmNode(e, t) {
    var a = getDomAllVals(e[0]),
        o = $.fn.zTree.getZTreeObj("dataParms"); (t = $.extend(!0, t, a)).name = a.parmCName,
        o.updateNode(t)
}
function setFrameId(e) {
    ...
    if (t) {
        ...
        hot.Methods.setCellMeta(a[0], a[1], "frameid", $(e).val()),
            hot.Methods.setDataAtCell(a[0], a[1], "subreport:" + $(e).find("option:selected").text())
    }
...
function removeReport() {
    ...
    if (e) {
        ...
        a.frameid = "",
            delete a.frameid,
            hot.Methods.setDataAtCell(t[0], t[1], "")
    }
}
function addSubReport() {
    ...
    if (e) {
        var t = e[0],
            a = hot.Methods.getCell(t[0], t[1]),
            o = $(a).offset().left + $(a).width(),
            n = $(a).offset().top + $(a).height(),
            r = hot.Methods.getCellMeta(t[0], t[1]).frameid;
        tempDataReportLayerIndex = layer.open({
            ...
            resize: !1,
            success: function(e, t) {
                e.find("#temlist").empty(),
                    e.find("#temlist").append("<option value=''>请选择子报表</option>"),
                    $.rdp.ajax({
                        url: "../../selectAllReportFile.action",
                        type: "post",
                        success: function(e) {
                            for (var t in e) {
                                var a = "";
                                r == e[t].uuid && (a = " selected = 'selected'"),
                                    $("#temlist").append("<option value='" + e[t].uuid + "' " + a + ">" + e[t].name + "</option>")
                            }
                        }
                    })
            },
...
var tempCoordsForSets, tempLayeroForSets, dragFlagForSets = !1,
    settingForSets = {
        view: {
...
function onDropForSets(e, t, a, o, n, r) {
    if (dragFlagForSets = !1, a[0].type && "field" == a[0].type) {
        var l = a[0].getParentNode().name,
            i = a[0].children,
            s = Number(tempCoordsForSets.row),
            d = Number(tempCoordsForSets.col);
        $.each(i,
            function(e, t) {
                hot.Methods.setDataAtCell(s, d + e, "=" + l + "." + t.name),
                    hot.Methods.setCellMeta(s, d + e, "columnName", t.columnName),
                    hot.Methods.setCellMeta(s, d + e, "columnType", t.columnType)
            }),
            tempCoordsForSets = {},
            console.log(a[0])
    } else {
        l = a[0].getParentNode().getParentNode().name;
        hot.Methods.setDataAtCell(tempCoordsForSets.row, tempCoordsForSets.col, "=" + l + "." + a[0].name),
            hot.Methods.setCellMeta(tempCoordsForSets.row, tempCoordsForSets.col, "columnName", a[0].columnName),
            hot.Methods.setCellMeta(tempCoordsForSets.row, tempCoordsForSets.col, "columnType", a[0].columnType),
            tempCoordsForSets = {}
    }
}
...
function zTreeBeforeRemoveForSets(e, t) {
    return layer.confirm("确认删除数据集  “" + t.name + "” 吗？", {
            btn: ["确定", "取消"]
        },
        function(e) {
            $.fn.zTree.getZTreeObj("dataSets").removeNode(t),
                layer.alert("删除成功!")
        },
        function(e) {
            layer.close(e)
...
function addParmItem(e) {
    var t = $('<div class="parm-item"><select></select><div class="btn-group"><i class="icon icon-insert"onclick="addParmItem(this);">+</i><i class="icon icon-del"onclick="delParmItem(this)">-</i></div></div>'),
        a = $.fn.zTree.getZTreeObj("dataParms").getNodesByParam("level", "1", null),
        o = t.find("select"); ($.each(a,
        function(e, t) {
...
function addParmItemForEdit(n, e) {
    var t = $.fn.zTree.getZTreeObj("dataParms").getNodesByParam("level", "1", null),
        r = "";
    $.each(t,
        function(e, t) {
...
function showSql(e) {
    var t = sqlFormatter.format(e.commandText),
        a = new RegExp("\n|\r\n", "g"),
        o = t.replace(a, "</br>").replace(/\s/g, "&nbsp;&nbsp;");
    $(".showsql").unbind().remove();
    var n = $('<div class="showsql" id="' + e.tId + '_showsql"></div>'),
        r = $("#" + e.tId + "_a"),
    ...
    n.append("&nbsp;&nbsp;&nbsp;&nbsp;" + o),
        ...
        "left" == l ? n.css({
            ...
            "border-radius": "5px",
            "z-index": 999
        }), n.css("top", r.offset().top - n.outerHeight(!0) + "px")),
        n.bind("click",
            function() {
                return ! 1
            })
...
function addDataSets(o) {
    layer.open({
        ...
        cancel: function() {},
        success: function(a, e) { (tempLayeroForSets = a).find("#DataSourceName").empty(),
            a.find("#DataSourceName").append('<option value=""></option><option value="javabean">javabean</option>'),
            $.rdp.ajax({
            ...
            a.find("#DataSourceName").bind("change",
                function() {
                    "javabean" == $(this).val() ? ($(a).find("#ddslist").hide(), $(a).find("#jblist").show()) : ($(a).find("#ddslist").show(), $(a).find("#jblist").hide())
                }),
            a.find(".formatterBtn").bind("click",
                function() {
                    var e = tempLayeroForSets.find("#CommandText").val(),
                        t = sqlFormatter.format(e);
                    tempLayeroForSets.find("#CommandText").val(t)
                }),
            a.find(".parm-list").empty(),
            o ? (setDomAllVals(a[0], o), addParmItemForEdit(a, o)) : setDomAllVals(a[0], {
                isvalid: !0
            }),
            "javabean" == a.find("#DataSourceName").val() ? ($(a).find("#ddslist").hide(), $(a).find("#jblist").show(), a.find("#FactoryClass").val(o.commandText)) : ($(a).find("#ddslist").show(), $(a).find("#jblist").hide())
        },
        end: function() {
            tempLayeroForSets = null
        },
        btn: ["保存", "取消"],
        yes: function(e, t) { (o ? editSetsNode(t, o) : addSetsNode(t)) && layer.close(e)
        },
        btn2: function(e, t) {
            layer.close(e)
        }
...
function addSetsNode(e) {
    var t, a = getDomAllVals(e.find(".form-info")[0]),
        o = a.dataSetName,
        n = a.dataSourceName,
        r = !0;
    if ("" == n) return window.top.layer.tips("请选择数据源", $(e).find("#DataSourceName"), {
        tipsMore: !0
    }),
        !1;
    if ("" == o) return window.top.layer.tips("数据集名称不能为空", $(e).find("#DataSetName"), {
        tipsMore: !0
    }),
        !1;
    if ("javabean" == n && (a.commandText = a.factoryClass), (a.dic || a.isvalid || "javabean" == n) && $.rdp.ajax({
        ...
        success: function(e) {
            e.flag ? (t = e.list, layer.msg("校验通过，保存成功", {
                time: 2e3
            })) : (layer.tips("sql错误", $(tempLayeroForSets).find("#CommandText"), {
                tipsMore: !0
            }), layer.closeAll("loading"), r = !1)
        },
        error: function() {
            layer.tips("sql错误", $(tempLayeroForSets).find("#CommandText"), {
                tipsMore: !0
        ...
        var l = $.fn.zTree.getZTreeObj("dataSets"),
            i = l.getNodes(),
            s = $.extend(!0, {},
                a);
        s.name = a.dataSetName,
            s = l.addNodes(i[0], s);
        var d = {
                name: "字段",
                type: "field",
        ...
        if (l.addNodes(c[0], u), t && 0 < t.length) {
            ...
            $.each(t,
                function(e, t) {
                    var a = t;
                    a.columnComments ? a.name = a.columnComments: a.name = a.columnName,
                        p.push(a)
                }),
                l.addNodes(d[0], p)
        } else l.addNodes(d[0], []);
...
function editSetsNode(e, a) {
    var n, r = $.fn.zTree.getZTreeObj("dataSets"),
        l = getDomAllVals(e.find(".form-info")[0]),
        i = !0,
        t = l.dataSetName,
        o = l.dataSourceName;
    if ("" == o) return window.top.layer.tips("请选择数据源", $(layero).find("#DataSourceName"), {
        tipsMore: !0
    }),
        !1;
    if ("" == t) return window.top.layer.tips("数据集名称不能为空", $(layero).find("#DataSetName"), {
        tipsMore: !0
    }),
        !1;
    if ("javabean" == o && (l.commandText = l.factoryClass), (a = $.extend(!0, a, l)).name = l.dataSetName, r.updateNode(a), (l.dic || l.isvalid || "javabean" == o) && $.rdp.ajax({
        ...
        success: function(e) {
            if (e.flag) {
                ...
                l.dic && settingDic(t[0]),
                    layer.msg("校验通过，保存成功", {
                        time: 2e3
                    })
            } else layer.tips("sql错误", $(tempLayeroForSets).find("#CommandText"), {
                tipsMore: !0
            }),
                i = !1
        },
...
function getParmListVals(e) {
    for (var t = [], a = e.getElementsByTagName("SELECT"), o = 0; o < a.length; o++) {
        var n = {},
            r = a[o].selectedIndex,
            l = "";
        a[o].options[r] && (l = a[o].options[r].text),
            n.name = l,
            n.parmCName = l,
            n.parmName = a[o].value,
            t.push(n)
    }
    return t
}
function settingDic(n) {
    layer.open({
        ...
        cancel: function() {},
        success: function(e, t) {
            e.find("#dicType").empty(),
                e.find("#dicID").empty(),
                e.find("#dicText").empty(),
                e.find("#dicType").append('<option value="">请选择字典类型</option>'),
                e.find("#dicID").append('<option value="">请选择字段名称</option>'),
                e.find("#dicText").append('<option value="">请选择值名称</option>');
            var a = n.children;
            $.each(a,
                function(e, t) {
                    $("#dicType").append('<option value="' + t.columnName + '">' + t.columnName + "</option>"),
                        $("#dicID").append('<option value="' + t.columnName + '">' + t.columnName + "</option>"),
                        $("#dicText").append('<option value="' + t.columnName + '">' + t.columnName + "</option>")
                });
            var o = n.getParentNode();
            e.find("#dicType").val(o.keyName),
                e.find("#dicText").val(o.optName),
                e.find("#dicID").val(o.optCode)
        },
        end: function() {},
        btn: ["保存", "取消"],
        yes: function(e, t) {
            var a = $.fn.zTree.getZTreeObj("dataSets"),
                o = n.getParentNode();
            o.keyName = t.find("#dicType").val(),
                o.optName = t.find("#dicText").val(),
                o.optCode = t.find("#dicID").val(),
                a.updateNode(o),
                layer.close(e)
        },
        btn2: function(e, t) {
...
function delImage() {
    ...
    0 < e.length && (hot.Methods.getCellMeta(e.data("r"), e.data("c")).image[e.data("index")] = {},
        e.unbind().remove())
}
function clearImage() {
    var e = hot.Methods.getSelected();
    if (e) {
        var t = e[0],
            a = hot.Methods.getCell(t[0], t[1]);
        hot.Methods.setCellMeta(t[0], t[1], "bgimage", ""),
            a.style.backgroundImage = ""
    }
}
function getImg() {
    var n = new FileReader,
        e = $("#importImage")[0].files[0];
    e && (n.readAsDataURL(e), n.onload = function(e) {
        if (105e4 < n.result.length) layer.msg("上传失败，请上传不大于1M的图片！");
        else {
            var t = hot.Methods.getSelected();
            if (t) {
                var a = t[0],
                    o = hot.Methods.getCell(a[0], a[1]);
                hot.Methods.setCellMeta(a[0], a[1], "image", n.result),
                    o.style.backgroundImage = 'url("' + n.result + '")',
                    o.style.backgroundRepeat = "no-repeat"
            }
        }
    })
...
function setOverlapping() {
    ...
    if (e) {
        var r = e[0],
            l = hot.Methods.getCellMeta(r[0], r[1]),
            a = hot.Methods.getCell(r[0], r[1]);
        n = l.overlapping || {},
            layer.open({
                type: 1,
                area: ["700px", "410px"],
                ...
                content: $("#overlapping"),
                cancel: function() {},
                success: function(e, t) { (tempOverlapping = e).find("#view-border").width($(a).outerWidth()).height($(a).outerHeight() - 1),
                    e.find("#lineHeight").val($(a).outerHeight() - 1),
                    e.find("#lineWidth").val($(a).outerWidth()),
                    e.find("#view-td").css("background-image", "").empty(),
                    e.find("#line").val(0),
                    e.find("#overlap-items").empty(),
                    e.find("#lineHeight").bind("input propertychange",
                        function() {
                            e.find("#view-border").height($(this).val())
                        }),
                    e.find("#lineWidth").bind("input propertychange",
                        function() {
                            e.find("#view-border").width($(this).val())
                        }),
                    e.find("#line").bind("change",
                        function() {
                            createItmes($(this).val())
                        }),
                    e.find("#viewOverlap").bind("click",
                        function() {
                            createViewLine()
                        }),
                    e.find("#overlapping-fontsize").bind("change input",
                        function() {
                    ...
                    e.find(".overlapping-color").spectrum({
                        ...
                        change: function(e) {
                            if ("overlapping-bgcolor" == this.id) $("#view-td").css("background-color", e.toRgbaString());
                            else if ("overlapping-fontcolor" == this.id) $(".overlap-node").css("color", e.toRgbString());
                            else if ("overlapping-linecolor" == this.id) {
                ...
                yes: function(t, a) {
                    ...
                    html2canvas(o[0]).then(function(e) {
                        n.base64 = e.toDataURL(),
                            n.nodes = [],
                            o.find(".overlap-node").each(function() {
                                var e = {};
                                e.top = $(this).css("top"),
                                    e.left = $(this).css("left"),
                                    e.value = $(this).text(),
                                    n.nodes.push(e)
                            }),
                            l.overlapping = n,
                            hot.Methods.setCellMetaObject(r[0], r[1], l),
                            TableData.rowHeights[r[0]] = Number(a.find("#lineHeight").val()),
                            TableData.colWidths[r[1]] = Number(a.find("#lineWidth").val()),
...
function clearoverlapping() {
    ...
    if (e) {
        var t = e[0],
            a = hot.Methods.getCell(t[0], t[1]);
        delete hot.Methods.getCellMeta(t[0], t[1]).overlapping,
            a.style.backgroundImage = ""
    }
}
...
function createViewLine(e) {
    var t = tempOverlapping.find("#view-td"),
        a = $("#overlapping-linecolor").spectrum("get").toRgbaString();
    if (e) line(t[0], 1, a, e.length - 1),
        addLabels(t, e);
    else {
        var o = tempOverlapping.find(".linenames-div"),
            n = [];
        $.each(o,
            function() {
                var e = {};
                e.value = $(this).find("[name=linenames]").val(),
                    n.push(e)
            }),
            line(t[0], 1, a, o.length - 1),
            addLabels(t, n)
    }
}
    ...
    o.empty(),
        $.each(e,
            function(e, t) {
                ...
                t.top && a.css("top", t.top),
                t.left && a.css("left", t.left),
                    a.css("color", $("#overlapping-fontcolor").spectrum("get").toRgbString()),
                    a.css("font-size", $("#overlapping-fontsize").val() + "px")
            })
}
function createLine(e, t, a) {
    if (!e && 0 <= t & 0 <= a) {
        ...
        e.base64 = line(o, 1, "#000000", e.val),
            hot.Methods.setCellMeta(t, a, "overlapping", e)
    } else {
        var n = hot.Methods.getSelected();
        if (n) {
            var r = n[0];
            hot.Methods.getCellMeta(r[0], r[1]),
                o = hot.Methods.getCell(r[0], r[1], !1);
            e.base64 = line(o, 1, "#000000", e.val),
                hot.Methods.setCellMeta(r[0], r[1], "overlapping", e),
            TableData.overlapping[r[0]] || (TableData.overlapping[r[0]] = []),
                TableData.overlapping[r[0]][r[1]] = e.val
        }
    }
}
function line(e, t, a, o) {
    ...
    return e.style.backgroundImage = 'url("' + s + '")',
        e.style.backgroundRepeat = "no-repeat",
        $(l).remove(),
        s
}
var hot, cPushArray = new Array,
    cStep = -1;
function cPush(e) {
    "init" == e && (tableInitFlag = !0),
    tableInitFlag && (++cStep < cPushArray.length && (cPushArray.length = cStep), cPushArray.push(getTabelData(!0)))
}
function cUndo() {
    tableInitFlag = !1,
    0 < cStep && loadCellData(cPushArray[--cStep]),
        tableInitFlag = !0
}
function cRedo() {
    tableInitFlag = !1,
    cStep < cPushArray.length - 1 && loadCellData(cPushArray[++cStep]),
        tableInitFlag = !0
}
$(function() {
    ...
    t.on("beforeFileQueued",
        ...
        t.on("uploadProgress",
            function(e, t) {
                $(".progress-bg").find(".progress-line").stop().animate({
                    width: 100 * t + "%"
                })
            }),
        t.on("uploadError",
...
var selectedCell, tempStyle, tempTableData, uuid = "",
    tableInitFlag = !1,
    TableData = {
        mergeCells: [],
        colWidths: [],
...
function getTabelData(e) {
    ...
    for (var t = 0,
             a = 0,
             o = hot.Methods.getSourceData(0, 0, hot.Methods.countRows() - 1, hot.Methods.countCols() - 1), n = 0; n < o.length; n++) for (var r = 0; r < o[n].length; r++) o[n][r] && (t = t < n ? n: t, a = a < r ? r: a);
    TableData.mergeCells = getMergeCells(TableData);
    var l = TableData.mergeCells;
    for (n = 0; n < l.length; n++) {
        t = (i = (p = l[n]).row + p.rowspan - 1) < t ? t: i,
            a = (s = p.col + p.colspan - 1) < a ? a: s
    }
    TableData.maxR = t,
        TableData.maxC = a,
    ...
    for (n = 0; n <= t; n++) {
        ...
        for (r = 0; r <= a; r++) {
            var s, d = hot.Methods.getCellMeta(n, r),
                c = d.value; (s = {}).value = c,
                s.width = hot.Methods.getColWidth(r),
                s.colwidth = getTDWidth(n, r, l),
                s.height = hot.Methods.getRowHeight(n),
                s.col = d.col,
                s.row = d.row,
                s.exptext = d.exptext,
                s.ds = d.ds,
                s.frameid = d.frameid,
                s.link = d.link,
                s.columnType = d.columnType,
                s.columnName = d.columnName,
                s.dic = d.dic,
                s.image = d.image,
                s.bgimage = d.bgimage,
                s.overlapping = d.overlapping,
                s.warnings = d.warnings,
                s.style = $.extend(!0, {
                        font_family: "SimSun"
                    },
                    d.style),
            s.style.font_family && "null" != s.style.font_family || (s.style.font_family = "SimSun"),
            s.style.font_size && "null" != s.style.font_size || (s.style.font_size = "12px"),
                s.className = d.className,
                i.col.push(s),
                TableData.colWidths[r] = hot.Methods.getColWidth(r),
                TableData.rowHeights[n] = hot.Methods.getRowHeight(n)
        }
        var u = hot.Methods.getCellMeta(n, 0);
        i.rowCategory = u.rowCategory ? u.rowCategory: "reporthead",
            TableData.row.push(i)
    }
    for (n = 0; n < l.length; n++) {
        var p = l[n];
        TableData.row[p.row].rowspan = p.rowspan,
            TableData.row[p.row].col[p.col].rowspan = p.rowspan,
            TableData.row[p.row].col[p.col].colspan = p.colspan
    }
    var f = $.fn.zTree.getZTreeObj("dataSets"),
        g = f.transformTozTreeNodes(f.getNodes());
    getDataSetsNodesVal(g);
    var m = $.fn.zTree.getZTreeObj("dataParms"),
        h = m.transformTozTreeNodes(m.getNodes());
    return TableData.dataSets = getDataSetsNodesVal(g),
        TableData.dataParms = getDataParmsNodesVal(h),
...
function tb_modif() {
    getTabelData(),
        uuid && "null" != uuid ? (tempTableData = $.extend(!0, {},
            ...
            data: {
                report: JSON.stringify(tempTableData)
            },
            type: "post",
            success: function(e) {
                layer.msg(e.msg)
...
function tb_wrap() {
    ...
    if (e) {
        ...
        for (var t = e,
            ...
            var n = hot.Methods.getCellMeta(a, o).style || {},
                r = hot.Methods.getCell(a, o);
            n.white_space && "normal" == n.white_space ? (delete n.white_space, $(r).css("white-space", ""), $(".toolbars .group .tag-btn.wrap-btn").removeClass("on")) : (n.white_space = "normal", $(r).css("white_space", "normal"), $(".toolbars .group .tag-btn.wrap-btn").addClass("on")),
                hot.Methods.setCellMeta(a, o, "style", n)
        }
...
function tb_category(e) {
    ...
    if (t) for (var a = t[0], o = a.from, n = a.to, r = o.row < n.row ? o.row: n.row, l = o.row > n.row ? o.row: n.row, i = r; i <= l; i++) console.log(e.value),
        hot.Methods.setCellMeta(i, 0, "rowCategory", e.value),
        initRowType(i, e.value)
}
...
function setBgColor(e) {
    ...
    if (t) {
        ...
        for (var i = a; i <= n; i++) for (var s = o; s <= r; s++) {
            ...
            d.background_color = e,
                hot.Methods.setCellMeta(i, s, "style", d);
...
function setFontColor(e) {
    ...
    if (t) {
        for (var a = t,
                 o = a[0]; o <= a[2]; o++) for (var n = a[1]; n <= a[3]; n++) {
        ...
        function(e, t) {
            switch (e = e.replace(/_/g, "-")) {
                ...
                case "text-decoration":
                    -1 < $.inArray("underline", l.text_decoration) && $(a).addClass("underline"),
                    -1 < $.inArray("strike", l.text_decoration) && $(a).addClass("strike"),
                    -1 < $.inArray("underline", l.text_decoration) && -1 < $.inArray("strike", l.text_decoration) && $(a).addClass("strike-underline");
                    break;
                default:
                    $(a).css(e, t)
            }
            ...
            function(e, t) {
                switch (e = e.replace(/_/g, "-")) {
                    ...
                    case "font-weight":
                        ...
                        break;
                    case "text-decoration":
                        -1 < $.inArray("underline", i.text_decoration) && $(".toolbars .group .tag-btn.btn-underline").addClass("on"),
                        -1 < $.inArray("strike", i.text_decoration) && $(".toolbars .group .tag-btn.btn-strike").addClass("on");
                        break;
...
function loadData(e) {
    ...
    e.mergeCells && 0 != e.mergeCells.length || (TableData.mergeCells = []),
...
function setFontFamily(e) {
    ...
    if (a) {
        for (var o = a[0], n = o[0]; n <= o[2]; n++) for (var r = o[1]; r <= o[3]; r++) {
            var l = hot.Methods.getCellMeta(n, r).style || {},
                i = hot.Methods.getCell(n, r);
            l.font_family = t,
                $(i).css("font-family", t),
                hot.Methods.setCellMeta(n, r, "style", l)
        }
        cPush("setFontFamily")
    }
}
...
function setFontStyle(e) {
    ...
    if (t) {
        for (var a = t[0], o = a[0]; o <= a[2]; o++) for (var n = a[1]; n <= a[3]; n++) {
            var r = hot.Methods.getCellMeta(o, n).style || {},
                l = hot.Methods.getCell(o, n);
            if ("italic" == e) r.font_style && "italic" == r.font_style ? (r.font_style = "normal", $(l).removeClass("italic"), $(".toolbars .group .tag-btn.btn-italic").removeClass("on")) : (r.font_style = "italic", $(l).addClass("italic"), $(".toolbars .group .tag-btn.btn-italic").addClass("on"));
            else if ("700" == e) r.font_weight && "700" == r.font_weight ? (r.font_weight = "normal", $(l).removeClass("bold"), $(".toolbars .group .tag-btn.btn-bold").removeClass("on")) : (r.font_weight = "700", $(l).addClass("bold"), $(".toolbars .group .tag-btn.btn-bold").addClass("on"));
            else if ("underline" == e) {
                if (r.text_decoration && -1 < $.inArray("underline", r.text_decoration)) {
                    var i = $.inArray("underline", r.text_decoration);
                    r.text_decoration.splice(i, 1),
                        $(l).removeClass("underline"),
                    ...
                    $(l).addClass("underline"),
                    $(".toolbars .group .tag-btn.btn-underline").addClass("on"); - 1 < $.inArray("underline", r.text_decoration) && -1 < $.inArray("strike", r.text_decoration) ? $(l).addClass("strike-underline") : $(l).removeClass("strike-underline")
            } else if ("strike" == e) {
                if (r.text_decoration && -1 < $.inArray("strike", r.text_decoration)) {
                    i = $.inArray("strike", r.text_decoration);
                    r.text_decoration.splice(i, 1),
                        $(l).removeClass("strike"),
                        $(".toolbars .group .tag-btn.btn-strike").removeClass("on")
                } else r.text_decoration || (r.text_decoration = []),
                    r.text_decoration.push("strike"),
                    $(l).addClass("strike"),
                    $(".toolbars .group .tag-btn.btn-strike").addClass("on"); - 1 < $.inArray("underline", r.text_decoration) && -1 < $.inArray("strike", r.text_decoration) ? $(l).addClass("strike-underline") : $(l).removeClass("strike-underline")
            }
            hot.Methods.setCellMeta(o, n, "style", r)
        }
        cPush("setFontStyle")
...
function setAlignmentV(e) {
    ...
    if (t) {
        for (var a = getRange(t), o = a[0]; o <= a[2]; o++) for (var n = a[1]; n <= a[3]; n++) {
            ...
            hot.Methods.setCellMeta(o, n, "className", l),
                hot.Methods.setCellMeta(o, n, "style", s)
        }
        cPush("setAlignmentV")
    }
}
function setAlignmentH(e) {
    ...
    if (t) {
        for (var a = getRange(t), o = a[0]; o <= a[2]; o++) for (var n = a[1]; n <= a[3]; n++) {
            ...
            hot.Methods.setCellMeta(o, n, "className", l),
                hot.Methods.setCellMeta(o, n, "style", i)
        }
        cPush("setAlignmentH")
    }
}
function getDomAllVals(e) {
    for (var t = e.getElementsByTagName("INPUT"), a = e.getElementsByTagName("TEXTAREA"), o = e.getElementsByTagName("SELECT"), n = {},
             r = 0; r < t.length; r++) t[r].name && ("checkbox" == t[r].type ? n[t[r].name] = t[r].checked: n[t[r].name] = t[r].value);
...
function setBorder(e) {
    ...
    if (t) {
        ...
        switch (e) {
            case "borderLeft":
                for (var o = a[0]; o <= a[2]; o++) { (l = hot.Methods.getCellMeta(o, a[1]).style || {}).border_left = "1px solid rgb(0,0,0)",
                    hot.Methods.setCellMeta(o, a[1], "style", l);
                    var n = hot.Methods.getCell(o, a[1]);
                    $(n).css("border-left", "1px solid rgb(0,0,0)")
                }
                break;
            case "borderRight":
                for (o = a[0]; o <= a[2]; o++) { (l = hot.Methods.getCellMeta(o, a[3]).style || {}).border_right = "1px solid rgb(0,0,0)",
                    hot.Methods.setCellMeta(o, a[3], "style", l);
                    n = hot.Methods.getCell(o, a[3]);
                    $(n).css("border-right", "1px solid rgb(0,0,0)")
                }
                break;
            case "borderTop":
                for (o = a[1]; o <= a[3]; o++) { (l = hot.Methods.getCellMeta(a[0], o).style || {}).border_top = "1px solid rgb(0,0,0)",
                    hot.Methods.setCellMeta(a[0], o, "style", l);
                    n = hot.Methods.getCell(a[0], o);
                    $(n).css("border-top", "1px solid rgb(0,0,0)")
                }
                break;
            case "borderBottom":
                for (o = a[1]; o <= a[3]; o++) { (l = hot.Methods.getCellMeta(a[2], o).style || {}).border_bottom = "1px solid rgb(0,0,0)",
                    hot.Methods.setCellMeta(a[2], o, "style", l);
            ...
            case "borderIn":
                ...
                break;
            case "borderAll":
                for (o = a[0]; o <= a[2]; o++) for (var r = a[1]; r <= a[3]; r++) { (l = hot.Methods.getCellMeta(o, r).style || {}).border_top = "1px solid rgb(0,0,0)",
                    l.border_bottom = "1px solid rgb(0,0,0)",
                    l.border_left = "1px solid rgb(0,0,0)",
                    l.border_right = "1px solid rgb(0,0,0)",
                    hot.Methods.setCellMeta(o, r, "style", l);
            ...
            case "borderNode":
                for (o = a[0]; o <= a[2]; o++) for (r = a[1]; r <= a[3]; r++) {
                    var l;
                    delete(l = hot.Methods.getCellMeta(o, r).style || {}).border_top,
                        delete l.border_bottom,
                        delete l.border_left,
                        delete l.border_right,
                        hot.Methods.setCellMeta(o, r, "style", l);
                    n = hot.Methods.getCell(o, r);
                    $(n).css({
                        "border-top": "",
...
function getDataSetsNodesVal(e) {
    ...
    return t && $.each(t,
        function(e, t) {
            ...
            n.dic = t.dic,
                n.isvalid = t.isvalid,
                n.dataSourceName = t.dataSourceName,
                n.dataSetName = t.dataSetName,
                n.dataSetType = t.dataSetType,
                n.commandText = t.commandText,
                n.keyName = t.keyName,
                n.optCode = t.optCode,
                n.optName = t.optName,
                $.each(t.children,
...
function getTDWidth(a, o, e) {
    ...
    if ($.each(e,
        function(e, t) {
            t.row == a && t.col == o && (n = t)
        }), n) for (var r = 0; r < n.colspan; r++) t += hot.Methods.getColWidth(o + r);
...
function guide_line(e) {
    ...
    if ($(".wtSpreader .guide_line").remove(), null != t && "" != t && null != t) {
        var o = $(".htCore").height(),
            n = $('<line class="guide_line ' + t + '_guide" title="' + a + '"></line>');
        n.css("height", o),
            $(".wtSpreader").append(n)
    }
}
